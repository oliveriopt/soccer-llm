...
Y cuando hago el deploy en azure en tables/stagingbrokerage_staging_orders.sql, usando este codigo:
...
CREATE OR REPLACE TABLE `sqlserver_to_bq_silver.stagingbrokerage_staging_orders` (
  ...
  tonu_charge NUMERIC,
  line_haul_pay_amount FLOAT64,
  fuel_pay_amount FLOAT64,
  order_cost FLOAT64,
  lh_rate NUMERIC,
  trip_count INT64,
...
Obtengo este error durante el deployment

5825Z Dry-run: definitions/sqlserver_to_bq_silver/udf/fn_trip_carrier_assign_date.sql
2026-03-10T14:43:25.8086197Z ✅ OK
2026-03-10T14:43:25.8086309Z 
2026-03-10T14:43:25.8086667Z ================================================================================
2026-03-10T14:43:25.8087041Z PRE-DEPLOY DRY-RUN FAILED
2026-03-10T14:43:25.8087418Z ================================================================================
2026-03-10T14:43:25.8087620Z 
2026-03-10T14:43:25.8087938Z  File: definitions/sqlserver_to_bq_silver/tables/stagingbrokerage_staging_orders.sql
2026-03-10T14:43:25.8088808Z --------------------------------------------------------------------------------
2026-03-10T14:43:25.8089436Z BigQuery error in query operation: Cannot replace a table with a different
2026-03-10T14:43:25.8089853Z partitioning spec. Instead, DROP the table, and then recreate it. New
2026-03-10T14:43:25.8090259Z partitioning spec is none and existing spec is
2026-03-10T14:43:25.8090665Z interval(type:day,field:order_date) clustering(order_key)
2026-03-10T14:43:25.8090840Z 
2026-03-10T14:43:25.8091117Z Total failures: 1
